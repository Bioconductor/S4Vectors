...
<script>
  $(document).ready(function() {
    $('div.slide').append('<div class=\"footnotes\">');
    ...
    $('footnote').each(function(index) {
      ...
      var slideParent = $(this).closest('div.slide');
      var oldContent = slideParent.children('div.footnotes').html();
      var newContent = oldContent + footnote;
      slideParent.children('div.footnotes').html(newContent);
    });
  });
</script>
