...
*DataFrame*). Many more are implemented in the `r Biocpkg("IRanges")` and `r
Biocpkg("GenomicRanges")` infrastructure packages, and in many other
...
objects follow the definition that these two functions are given the `r
Rpackage("base")` package.
